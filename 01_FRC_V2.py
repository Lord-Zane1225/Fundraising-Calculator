...
# calculate minimum selling price and round it to nearest selected dollar amount
...
to_write = [main_heading_string, quantity_string,
            ...
            "\n", fixed_heading_string, fixed_panda_string, fixed_subtotal_string,
            selling_price_heading, total_expense_string, profit_goal_string, sales_target_string,
